...
def process_song_data(spark, input_data, output_data):
    ...
    logger.info('songs.parquet write finished!')
    ...
    logger.info('artists.parquet write finished!')
...
def process_log_data(spark, input_data, output_data):
    ...
    logger.info('users.parquet write finished!')
    ...
    logger.info('time.parquet write finished!')
    ...
    logger.info('songplays.parquet write finished!')
