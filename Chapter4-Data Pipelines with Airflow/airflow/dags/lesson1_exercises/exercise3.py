...
def hello_world():
    logging.info(f"【{datetime.datetime.now()}】Hello World")


def addition():
    logging.info(f"【{datetime.datetime.now()}】2 + 2 = {2+2}")


def subtraction():
    logging.info(f"【{datetime.datetime.now()}】6 -2 = {6-2}")


def division():
    logging.info(f"【{datetime.datetime.now()}】10 / 2 = {int(10/2)}")


dag = DAG(
    "lesson1.exercise3-V2",
